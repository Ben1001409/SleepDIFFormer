...
dir_path="/home/tester1/YT/Ben/SleepDiFFormer/data/datasets2/ISRUC_extracted/group3"
...
for i in range(1, 11):
    ...
    psg_f_names.append(f'{dir_path}/{numstr}/{numstr}/{numstr}.rec')
    label_f_names.append(f'{dir_path}/{numstr}/{numstr}/{numstr}_1.txt')
