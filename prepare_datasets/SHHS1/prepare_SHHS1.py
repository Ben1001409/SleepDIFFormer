...
dir_path_psg = '/home/tester1/YT/Ben/SleepDiFFormer/data/datasets/shhs/polysomnography/edfs/shhs1'
dir_path_ann = '/home/tester1/YT/Ben/SleepDiFFormer/data/datasets/shhs/polysomnography/annotations-events-profusion/shhs1'

seq_dir = '/home/tester1/YT/Ben/SleepDiFFormer/data/datasets/GSS_datasets/SHHS1/seq'
label_dir = '/home/tester1/YT/Ben/SleepDiFFormer/data/datasets/GSS_datasets/SHHS1/labels'
...
for psg_f_name, label_f_name in tqdm(psg_label_f_pairs):
    ...
    psg_df = raw.to_data_frame()
    print(psg_df.shape)

    #Extract EEG, EOG(R), EOG(L)
    eeg = psg_df['EEG'].values
    eog_r = psg_df['EOG(R)'].values
    eog_l = psg_df['EOG(L)'].values

    eog_diff = eog_r - eog_l

    psg_array = np.stack([eeg, eog_diff], axis=1)
    print("Shape of psg: ", psg_array.shape)
