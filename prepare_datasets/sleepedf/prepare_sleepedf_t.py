...
dir_path="/home/tester1/YT/dataset/sleep_dataset/physionet.org/files/sleep-edfx/1.0.0/sleep-telemetry/"
...
for psg_f_name, label_f_name in tqdm(psg_label_f_pairs):
    ...
    if not os.path.isdir("/home/tester1/YT/Ben/SleepDiFFormer/data/datasets/t-sleep-edf-npy-filter40/"):
        os.makedirs("/home/tester1/YT/Ben/SleepDiFFormer/data/datasets/t-sleep-edf-npy-filter40/")
    with open('/home/tester1/YT/Ben/SleepDiFFormer/data/datasets/t-sleep-edf-npy-filter40/' + psg_f_name[3:6] + 'seq.npy', 'wb') as f:
        np.save(f, epochs_seq)
    with open('/home/tester1/YT/Ben/SleepDiFFormer/data/datasets/t-sleep-edf-npy-filter40/' + label_f_name[3:6] + 'label.npy', 'wb') as f:
