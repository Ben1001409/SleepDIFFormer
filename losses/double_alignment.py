...
class CORAL(nn.Module):
    def __init__(self):
        ...
        # self.align = nn.Linear(256, 256, bias=False)
    ...
    def forward(self, features, domains):
        ...
        #print("Shape of domains: ",domains.shape)
        ...
        loss2_a,loss2_b = self.metric_diff(means_pairs, covas_pairs) # epoch level alignment loss
        loss2 = self.relation_diff(relations_pairs) 
        # print(loss1, loss2)
        return (loss2_a,loss2_b), loss2
        #return loss1 + loss2
