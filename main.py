...
def main():
    ...
    for dataset_name in datasets:
        ...
        parser.add_argument('--num_layers',type=int, default=4,help='number of layers of encoder ')
        ...
        parser.add_argument("--patch_len",type=int,default=50,help="patch length for each epoch")
